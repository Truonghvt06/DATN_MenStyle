...
import auth from '@react-native-firebase/auth'; // ✅ Sửa import đúng
...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    if (!email || !password) {
      setErrorInp('Vui lòng nhập đầy đủ thông tin!');
      return;
    }
  ...
  const handleRegister = () => navigation.navigate(ScreenName.Auth.Register);
        ...
        <Block flex1 middle>
          <Block
            ...
            <KeyboardAvoidingView
              ...
              <ButtonBase title="Đăng nhập" onPress={handleLogin} />

              <Block row middle marT={20}>
